  ...
  const providers = [
    {
      ...
      name: "OpenAI",
      models: [
        { name: "gpt-4o", id: 0, disable: false },
        { name: "gpt-4o-mini", id: 1, disable: false },
        { name: "gpt-4-turbo", id: 2, disable: false },
        { name: "gpt-4", id: 3, disable: false },
        { name: "gpt-4o-audio-preview", id: 4, disable: false },
        { name: "gpt-3.5-turbo", id: 5, disable: false },
      ],
      icon: openaiImg,
    },
    {
    ...
    },
    {
      ...
      models: [
        ...
        { name: "claude-3-opus-20240229", id: 11, disable: true },
        { name: "claude-3-sonnet-20240229", id: 12, disable: true },
        { name: "claude-3-haiku-20240307", id: 13, disable: true },
      ],
      icon: anthropicImg,
    },
    {
      ...
      name: "Google",
      models: [
        { name: "gemini-1.5-flash", id: 14, disable: false },
        { name: "gemini-1.5-pro", id: 15, disable: false },
      ],
      icon: googleImg,
    },
    {
      ...
      name: "Groq",
      models: [
        { name: "llama-3.1-405b-reasoning", id: 16, disable: true },
        { name: "llama-3.1-70b-versatile", id: 17, disable: true },
        { name: "llama-3.1-8b-instant", id: 18, disable: true },
        { name: "mixtral-8x7b-32768", id: 19, disable: true },
        { name: "gemma2-9b-it", id: 20, disable: true },
      ],
      icon: groqImg,
    },
  ];
