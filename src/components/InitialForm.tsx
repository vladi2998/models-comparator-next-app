...
export function InitialForm() {
  ...
  const providers = [
    ...
    },
    {
      ...
      name: "Anthropic",
      models: [
        { name: "claude-3-5-sonnet-20241022", id: 9, disable: false },
        { name: "claude-3-5-sonnet-20240620", id: 10, disable: false },
        { name: "claude-3-opus-20240229", id: 11, disable: false },
        { name: "claude-3-sonnet-20240229", id: 12, disable: false },
        { name: "claude-3-haiku-20240307", id: 13, disable: false },
      ],
      icon: anthropicImg,
    },
    {
